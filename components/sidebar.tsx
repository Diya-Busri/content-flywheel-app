  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/dashboard/orders", icon: <Inbox size={18} />, label: "Orders", emoji: "🛒", activeWhenStartsWith: true },
        { href: "/dashboard/reviews", icon: <Star size={18} />, label: "Reviews", emoji: "⭐", activeWhenStartsWith: true },
        { href: "/dashboard/discount-codes", icon: <Tag size={18} />, label: "Discount Codes", emoji: "🎟️", activeWhenStartsWith: true },
        { href: "/dashboard/affiliates", icon: <Gift size={18} />, label: "Affiliates", emoji: "🔗", activeWhenStartsWith: true },
        { href: "/dashboard/email-marketing", icon: <Mail size={18} />, label: "Email Marketing", emoji: "📧", activeWhenStartsWith: true },
        { href: "/dashboard/email-sequences", icon: <Mail size={18} />, label: "Email Sequences", emoji: "📨", activeWhenStartsWith: true },
        { href: "/dashboard/analytics", icon: <BarChart2 size={18} />, label: "Analytics", emoji: "📊", activeWhenStartsWith: true },
        { href: "/dashboard/store/tax", icon: <Receipt size={18} />, label: "Tax & VAT", emoji: "🧾", activeWhenStartsWith: true },
        { href: "/dashboard/store/payouts", icon: <Wallet size={18} />, label: "Payouts", emoji: "💳", activeWhenStartsWith: true },
