...
import {
  Lightbulb, Sparkles, Store, Megaphone,
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Stripe payments, automatic download delivery, discount codes",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-sm text-white/30">
            Everything from idea to first sale happens{" "}
            <span className="text-orange-400 font-semibold">right here</span>.
          </p>
        </motion.div>
      </div>
    </section>
