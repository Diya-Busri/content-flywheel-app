...
const OUTCOMES = [
  ...
  },
  {
    ...
    step: "04",
    title: "Drive Sales",
    desc: "Sell from your own branded store on Content Flywheel — then use your content to drive a steady stream of buyers. No third-party cut, no platform dependency.",
