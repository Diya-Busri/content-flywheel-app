        ...
        <div className="relative p-6 md:p-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="space-y-3 flex-1 min-w-0">
              ...
              <p className="text-orange-100 text-sm md:text-base leading-relaxed max-w-lg">
                {message}
              </p>
            ...
            <div className="flex flex-col items-start md:items-end gap-3 shrink-0">
              <button
                ...
                className="inline-flex items-center gap-2 bg-white text-orange-600 hover:bg-orange-50 active:bg-orange-100 font-bold px-6 py-3 rounded-xl transition-all shadow-lg hover:shadow-xl text-sm whitespace-nowrap"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-orange-100 hover:text-white text-xs font-medium transition-colors"
              >
                + New product
