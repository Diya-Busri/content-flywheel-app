...
import { ArrowRight, Check, Github, Sparkles, Twitter } from "lucide-react";
      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#0B0B0F]/70 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm text-white/70 md:flex">
            ...
            <Link href="#who-its-for" className="transition-colors hover:text-white">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="#waitlist"
              className="hidden rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm text-white/90 transition hover:border-white/25 hover:bg-white/10 md:inline-flex"
            >
              Join waitlist
            </Link>
            <Link
              href="#waitlist"
              className="inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-semibold text-[#0B0B0F] shadow-[0_0_0_1px_rgba(245,201,122,0.25),0_12px_30px_rgba(245,201,122,0.20)] transition hover:shadow-[0_0_0_1px_rgba(245,201,122,0.35),0_16px_40px_rgba(245,201,122,0.25)]"
