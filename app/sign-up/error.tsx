...
export default function SignUpError({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0F0F0F] px-4 text-white">
      <div className="max-w-md space-y-6 rounded-xl border border-gray-800 bg-gray-900 p-8">
        ...
        <ol className="list-inside list-decimal space-y-2 text-sm text-gray-300">
          <li>
            Open <code className="rounded bg-gray-800 px-1.5 py-0.5 text-xs">.env.local</code> and add:
            <pre className="mt-2 overflow-x-auto rounded bg-gray-800 p-3 text-xs">
...
CLERK_SECRET_KEY=sk_test_...`}
          ...
          <li>Restart the dev server (<code className="rounded bg-gray-800 px-1.5 py-0.5">npm run dev</code>)</li>
