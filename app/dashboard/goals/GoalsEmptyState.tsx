    ...
    <main className="min-h-screen bg-[#F9FAFB] dark:bg-[#0F0F0F] text-gray-900 dark:text-white">
      ...
      <div className="p-6 md:p-10 max-w-4xl mx-auto">
        ...
        <section className="grid gap-4 sm:grid-cols-3 mt-8 md:mt-12 pb-16">
          <Card className="border-[#E5E7EB] dark:border-slate-800 bg-white dark:bg-[#1A1A1A]">
            <CardHeader className="pb-2">
              <div className="flex items-center gap-2 mb-1">
                <ClipboardList className="w-5 h-5 text-orange-500 dark:text-orange-400 shrink-0" />
                <CardTitle className="text-base text-gray-900 dark:text-white">Daily Tasks</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-[#E5E7EB] dark:border-slate-800 bg-white dark:bg-[#1A1A1A]">
            <CardHeader className="pb-2">
              <div className="flex items-center gap-2 mb-1">
                ...
                <CardTitle className="text-base text-gray-900 dark:text-white">Proof Required</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 dark:text-slate-400">
          ...
          <Card className="border-[#E5E7EB] dark:border-slate-800 bg-white dark:bg-[#1A1A1A]">
            <CardHeader className="pb-2">
              <div className="flex items-center gap-2 mb-1">
                ...
                <CardTitle className="text-base text-gray-900 dark:text-white">Streak Tracking</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 dark:text-slate-400">
