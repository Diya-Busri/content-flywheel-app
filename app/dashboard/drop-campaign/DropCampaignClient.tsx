...
import { Sparkles, Loader2, Copy, Check, ChevronDown, ChevronUp, RefreshCw, Mail, Zap, BookMarked, Shirt, CheckCircle2 } from "lucide-react";
...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button onClick={copy} className="p-1 rounded hover:bg-gray-100 dark:hover:bg-[#2A2A2A] text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors">
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Pick a product and get a complete 7-day launch campaign — TikTok scripts, Instagram captions, stories, and a launch email.
        </p>
      </div>
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                ...
                {allSaved ? "All saved!" : "Save all to Library"}
              </Button>
