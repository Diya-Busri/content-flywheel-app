                ...
                <div className="space-y-1.5">
                  ...
                  {products.length === 0 && (
                    <p className="text-xs text-muted-foreground">
                      No products yet?{" "}
                      <Link href="/dashboard/launch" className="text-orange-500 hover:text-orange-400 underline underline-offset-2">
                        Launch with AI
                      </Link>{" "}
                      or{" "}
                      <Link href="/dashboard/digital-products" className="text-orange-500 hover:text-orange-400 underline underline-offset-2">
                        create one manually
                      </Link>{" "}
                      — then come back here.
                    </p>
