...
import {
  ...
  AlertTriangle, Rocket, Store, ExternalLink,
} from "lucide-react";
  ...
  return (
    <div className="min-h-dvh bg-background">
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        {/* ── Bottom actions ── */}
        {isComplete && (
          <div className="mt-8 rounded-2xl border border-border/50 bg-card/60 p-5">
            <p className="text-[12px] font-bold text-foreground mb-3">Next steps</p>
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
              {productId && (
                <a href={`/dashboard/products/${productId}#publish`}
                  className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-orange-500/30 bg-orange-500/[0.05] hover:bg-orange-500/[0.1] transition-colors">
              ...
              {storeUrl && (
                <a href={storeUrl} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-border/60 bg-card/60 hover:bg-muted/40 transition-colors">
                  <ExternalLink className="w-3.5 h-3.5 text-muted-foreground shrink-0" />
                  <span className="text-[12px] font-semibold text-foreground">Preview Store</span>
                </a>
              )}
              <a href="/dashboard"
                className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-border/60 bg-card/60 hover:bg-muted/40 transition-colors">
                <Store className="w-3.5 h-3.5 text-muted-foreground shrink-0" />
                <span className="text-[12px] font-semibold text-foreground">Dashboard</span>
              </a>
            </div>
          </div>
        )}
